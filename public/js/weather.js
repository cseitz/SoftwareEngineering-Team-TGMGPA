...
(async () => {
  let { city: usercity, country_code: ocountry, region_code: state } = await (await fetch('https://api.ipstack.com/check?access_key=5448cfde5052f498a30a03b5055fdf3e&format=1')).json();
